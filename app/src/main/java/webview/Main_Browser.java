...
public class Main_Browser<DatabaseHelper> extends Activity implements OnLongClickListener, OnClickListener, OnGestureListener, OnTouchListener {
	private static final String[] countriesStr = { "张三", "李四", "王五", "赵六" };
	private static final String[] sousuo = { "张三", "李四", "王五", "赵六" };
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/* String service=NOTIFICATION_SERVICE;
	        ...
	        notification.setLatestEventInfo(Main_Browser.this, "CBrowser", "感谢您对squirrel桓的支持，祝您生活愉快！", pendingIntent);
		...
		// 图标页
		GridView gridview1 = (GridView) findViewById(R.id.gridview1);// 生成动态数组，并且转入数据
		...
		CB_webview.getSettings().setBuiltInZoomControls(true); // 缩放
    ...
    private void createFloatView()
    {
        ...
        //鑾峰彇鐨勬槸LocalWindowManager瀵硅薄
        mWindowManager = this.getWindowManager();
     
        //鑾峰彇鐨勬槸CompatModeWrapper瀵硅薄
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {// 捕捉返回键
		...
		if ((keyCode == KeyEvent.KEYCODE_BACK) && CB_webview.canGoBack()) {
			...
			onDoubleClick(1);// 按了返回键，但已经不能返回，则执行退出确认
			return true;
		}
	...
	public void ConfirmExit() {// 退出确认
		...
		ad.setPositiveButton("是", new DialogInterface.OnClickListener() {// 退出按钮
					...
					public void onClick(DialogInterface dialog, int i) {
						// TODO Auto-generated method stub
						Main_Browser.this.finish();// 关闭activity
					}
				});
